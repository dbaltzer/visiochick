...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        // VisioChick
        public List<int> VertPerBezierSegment = new List<int>();
        ...
        VertexPath (BezierPath bezierPath, VertexPathUtility.PathSplitData pathSplitData, Transform transform) {
            ...
            // VisioChick:
            VertPerBezierSegment = pathSplitData.numVerticesPerSegment;
        ...
        #region VISIOCHICK_ADDED_FUNCTIONS

        public float GetDistanceOfVertex(int index) {
            return cumulativeLengthAtEachVertex[index];
        }

        public int GetIndexOfClosestPointOnPath(Vector3 worldPoint) {
            TimeOnPathData data = CalculateClosestPointOnPathData (worldPoint);
