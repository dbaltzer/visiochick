...
namespace PathCreation {
    ...
    public class BezierPath {
        ...
        #region VisioChick_AddedMethods
        ...
        /// </summary>
        /// <param name="globalIndex"> anchor index aka point in path</param>
        public Vector3 GetAnchorPointLocalPos(int globalIndex) {
            return GetPointsInSegment(globalIndex)[0];
        }

        public List<float> GetPerAnchorNormalsAngle() {
